...
# Helper function to create a question with the given `question_text` and published the
...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_published_recently() returns True for quesitons whose publish_date is within the last day.
        """
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_future_question(self):
        """
        The detail view of a question with a publish_date in the future returns a 404 not found.
        """
    ...
    def test_past_question(self):
        """
        The detail view of a question with a publish_date in the past displays the questions's text.
        """
