...
class TestMapEngine(unittest.TestCase):
    ...
    def test_add_entity_to_map_no_map_case(self):
        ...
        with self.assertRaises(ValueError) as context:
            engine_of_eternity.add_entity_to_map(map=None, entity=sexy_beast)
    ...
    def test_add_entity_to_map_SUCCESS_case(self):
        ...
        some_plain = Plain()
        some_plain.initialize(10, 10)
        just_a_game.set_map(some_plain)
    ...
    def test_add_entity_to_map_DUPLICATE_case(self):
        ...
        self.assertEqual(
            just_a_game.map.grid[x_cord + 1][y_cord + 1].occupant,
            the_victim
        )
    ...
    def test_add_entity_to_map_OUT_OF_BOUNDS_case(self):
        ...
        with self.assertRaises(KeyError):
            engine_of_eternity.add_entity_to_map(some_plain, the_lost_one)
    ...
    def test_remove_entity_from_map_SUCCESS_case(self):
        ...
        the_victim = Plebian()
        chump_entityengine.set_entity_position(the_victim, x_cord, y_cord)
        chump_mapengine.add_entity_to_map(some_plain, the_victim)

        # Now we remove the victim. I feel like I'm some mafia member cleaning the scene.
        chump_mapengine.remove_entity_from_map(some_plain, the_victim)
        self.assertEqual(
    ...
    def test_remove_entity_from_map_EMPTY_case(self, mock_print):
        ...
        chump_mapengine.remove_entity_from_map(some_plain, mr_waffles)
    ...
    def test_remove_entity_from_map_NO_MAP_case(self):
        ...
        with self.assertRaises(ValueError) as context:
            chump_mapengine.remove_entity_from_map(map=None, entity=some_guy)
    ...
    def test_remove_entity_from_map_non_entity_case(self):
        ...
        with self.assertRaises(AttributeError) as context:
            chump_mapengine.remove_entity_from_map(chump_game, 666)
    ...
    def test_check_if_occupied_NO_MAP_case(self):
        ...
        y_cord = 2
        with self.assertRaises(ValueError) as context:
            mappy_mapengine.check_if_occupied(map=None, x_cord=x_cord, y_cord=y_cord)
    ...
    def test_check_if_occupied_OUT_OF_BOUNDS_case(self):
        ...
        with self.assertRaises(KeyError):
            the_engine.check_if_occupied(smallest_plain, x_cord, y_cord)
    ...
    def test_check_if_occupied_FALSE_case(self):
        ...
        self.assertEqual(
            mappy_mapengine.check_if_occupied(plane, x_cord, y_cord),
            False
        )
    ...
    def test_check_if_occupied_TRUE_case(self):
        ...
        mappy_mapengine.add_entity_to_map(the_void, master_of_the_universe)

        self.assertEqual(
            mappy_mapengine.check_if_occupied(the_void, x_cord, y_cord),
            True
        )